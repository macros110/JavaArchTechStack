package com.macrodream.spring.guides.gs.accessingdategemfire;
...
public class AccessingDataGemfireApp {
    public static void main(String[] args) {
        SpringApplication.run(AccessingDataGemfireApp.class, args);
    }
