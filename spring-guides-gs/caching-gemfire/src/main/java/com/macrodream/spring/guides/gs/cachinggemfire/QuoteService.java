...
public class QuoteService {
    protected static final String ID_BASED_QUOTE_SERVICE_URL = "http://localhost:8081/api/{id}";
    protected static final String RANDOM_QUOTE_SERVICE_URL = "http://localhost:8081/api/random";
